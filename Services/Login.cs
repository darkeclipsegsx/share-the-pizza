 ...
 * Nicole Reed
 * 
 * Facilitates the logging into Share the Pizza
 * Contains logic for forgotten passwords, changing passwords, adding/removing/modifying new users, and logging in
 * 
 * Utilizes a 20 byte salt and a SHA256 hash for password security
 * 
 * 
 * Enjoy!
 * 
